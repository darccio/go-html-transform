...
var simpleTokenTests = []struct {
	...
	// TODO {`123e10`, []Token{Token{Type: Number, String: `123e10`}}},
	...
	// TODO {`td\91f6dt`, []Token{Token{Type: Ident, String: `td\91f6dt`}}},
	// Strings
	...
	// TODO Unicode Range
	//{`u91f651`, []Token{Token{Type: String, String: `u91f6td`}}},
...
func TestEscaped(t *testing.T) {
	for _, c := range escapedCases {
		n, tok, err := consumeEscaped([]byte(c.input), c.atEOF)
		if string(tok) != c.expected {
			t.Errorf("Expected %q got %q consumed: %d", c.expected, tok, n)
		}
		if !compareErrors(err, c.err) {
